...
private:
	...
	//Uses fuzzy logic to modify the aiming
	Raven_NoiseSystem*				 m_pWeaponNoiseSystem;
...
public:
	...
	void          SetTeam(Raven_Team* vTeam) { this->m_pTeam = vTeam; }
	void		  SetLearning(bool b) { m_isLearning = b; }
	...
	Raven_NoiseSystem* const			 GetNoiseSystem() { return m_pWeaponNoiseSystem; }
