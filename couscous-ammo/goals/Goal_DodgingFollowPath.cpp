#include "Goal_DodgingFollowPath.h"
#include "../Raven_Bot.h"
...
//------------------------------ ctor -----------------------------------------
//-----------------------------------------------------------------------------
Goal_DodgingFollowPath::
Goal_DodgingFollowPath(Raven_Bot*          pBot,
	std::list<PathEdge> path) :Goal_Composite<Raven_Bot>(pBot, goal_dodging_follow_path),
	m_Path(path)
{
}
...
//------------------------------ Activate -------------------------------------
//-----------------------------------------------------------------------------
void Goal_DodgingFollowPath::Activate()
{
	m_iStatus = active;
	...
	default:
		...
		throw std::runtime_error("<Goal_DodgingFollowPath::Activate>: Unrecognized edge type");
	}
}
...
//-------------------------- Process ------------------------------------------
//-----------------------------------------------------------------------------
int Goal_DodgingFollowPath::Process()
{
...
//---------------------------- Render -----------------------------------------
//-----------------------------------------------------------------------------
void Goal_DodgingFollowPath::Render()
{
